...
def sensor_callback(sensor_data, sensor_queue, sensor_name):
    ...
    if sensor_data.frame%3==0:
        if sensor_name=="cam1":
            sensor_data.save_to_disk('/home/junchuan/Downloads/junchuan/CARLA/test_data/test01/1_%.6f.jpg' % sensor_data.timestamp)
        if sensor_name=="cam2":
            sensor_data.save_to_disk('/home/junchuan/Downloads/junchuan/CARLA/test_data/test01/2_%.6f.jpg' % sensor_data.timestamp)
        if sensor_name=="cam3":
            sensor_data.save_to_disk('/home/junchuan/Downloads/junchuan/CARLA/test_data/test01/3_%.6f.jpg' % sensor_data.timestamp)
        if sensor_name=="cam4":
            sensor_data.save_to_disk('/home/junchuan/Downloads/junchuan/CARLA/test_data/test01/4_%.6f.jpg' % sensor_data.timestamp)
        if sensor_name=="cam5":
            sensor_data.save_to_disk('/home/junchuan/Downloads/junchuan/CARLA/test_data/test01/5_%.6f.jpg' % sensor_data.timestamp)
        if sensor_name=="cam6":
            sensor_data.save_to_disk('/home/junchuan/Downloads/junchuan/CARLA/test_data/test01/6_%.6f.jpg' % sensor_data.timestamp)
        if sensor_name=="cam7":
            sensor_data.save_to_disk('/home/junchuan/Downloads/junchuan/CARLA/test_data/test01/7_%.6f.jpg' % sensor_data.timestamp)
        if sensor_name=="cam8":
            sensor_data.save_to_disk('/home/junchuan/Downloads/junchuan/CARLA/test_data/test01/8_%.6f.jpg' % sensor_data.timestamp)
